...
static void* t_range_stats(long long t_n);
static void* t_pair(long long t_n);
static void* t_minmax(long long t_a, long long t_b);


int main(void) {
    const char* t_label = NULL;
    long long t_c;
    long long t_s;
    { void* __t_t = t_range_stats(100);
      t_c = (long long) ((long long*)__t_t)[0];
      t_s = (long long) ((long long*)__t_t)[1];
      __t_free(__t_t); }
    printf("%lld\n", (long long)(t_c));
    printf("%lld\n", (long long)(t_s));
    long long t_num;
    const char* t_label = NULL;
    { void* __t_t = t_pair(5);
      t_num = (long long) ((long long*)__t_t)[0];
      t_label = (const char*) ((long long*)__t_t)[1];
      __t_free(__t_t); }
    printf("%lld\n", (long long)(t_num));
    printf("%s\n", (t_label));
    long long t_lo;
    long long t_hi;
    { void* __t_t = t_minmax(3, 7);
      t_lo = (long long) ((long long*)__t_t)[0];
      t_hi = (long long) ((long long*)__t_t)[1];
      __t_free(__t_t); }
    printf("%lld\n", (long long)(t_lo));
    printf("%lld\n", (long long)(t_hi));
    __t_free(t_label); t_label = NULL;
    return 0;
}
...
static void* t_range_stats(long long t_n) {
    ...
    { void* t_ret = __t_malloc(16);
      ((long long*)t_ret)[0] = (long long)(t_count);
      ((long long*)t_ret)[1] = (long long)(t_sum);
    return t_ret; }
    return NULL;
}
...
static void* t_pair(long long t_n) {
    { void* t_ret = __t_malloc(16);
      ((long long*)t_ret)[0] = (long long)(t_n);
      ((long long*)t_ret)[1] = (long long)(__t_dup("hello"));
    return t_ret; }
    return NULL;
}
...
static void* t_minmax(long long t_a, long long t_b) {
    { void* t_ret = __t_malloc(16);
      ((long long*)t_ret)[0] = (long long)(t_a);
      ((long long*)t_ret)[1] = (long long)(t_b);
    return t_ret; }
    return NULL;
}
